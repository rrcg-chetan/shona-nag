...
import axios from 'axios';
      ...
      class Demography extends PureComponent {
        ...
        /*onSubmit = async e => {
          //e.preventDefault();
          await axios.post(`https://shona-nag-cms.herokuapp.com/patientdetails`, { patient_name: this.state.patient_name, city: this.state.city, country: this.state.country, hospital_id: this.state.hospital_id, patient_initial: this.state.patient_initial, date_of_birth: this.state.date_of_birth, age_of_diagnosis: this.state.age_of_diagnosis, date_of_diagnosis: this.state.date_of_diagnosis, praffin: this.state.praffin, profession: this.state.profession, other_profession: this.state.other_profession, ethnicity: this.state.ethnicity, other_ethnicity: this.state.other_ethnicity, height: this.state.height, weight: this.state.weight, bmi: this.state.bmivalue, family_ho_cancer: this.state.family_ho_cancer, family_has_cancer: this.state.family_has_cancer, other_family_has_cancer: this.state.other_family_has_cancer, type_of_cancer: this.state.type_of_cancer, age_at_diagnosis_of_relative: this.state.age_at_diagnosis_of_relative, presenting_symptom: this.state.presenting_symptom, monthly_family_income: this.state.monthly_family_income, amount: this.state.amount, co_morbidities: this.state.co_morbidities, other_co_morbodities: this.state.other_co_morbodities})
          .then(() => {
            let history = useHistory();
            history.push("/inital");
          });
      ...
      return (
        ...
        onInvalidSubmit={this.handleInvalidSubmit}>
                    ...
                    <div className="col-md-3">
                      ...
                      <div className="col-md-12">
                      <Button color='primary' type='submit' disabled={!this.state.patient_name.length || !this.state.city.length || !this.state.country.length || !this.state.patient_initial.length || !this.state.date_of_birth.length || !this.state.age_of_diagnosis.length || !this.state.date_of_diagnosis.length || !this.state.praffin.length || !this.state.profession.length || !this.state.ethnicity.length || !this.state.family_ho_cancer.length || !this.state.age_at_diagnosis_of_relative.length || !this.state.presenting_symptom.length || !this.state.monthly_family_income.length || !this.state.amount.length || !this.state.co_morbidities.length} onClick={ () => this.sendPatientDetails }>
                        Submit
                      </Button>              
                      </div>    
                    </div>
