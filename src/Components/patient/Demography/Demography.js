        ...
        showMenstrualHistory(name) {
          if(document.getElementById("menstrualhistory").value == "Irregular"){
            ...
            this.state.menstrual_history = name 
              ...
              this.setState({ showMenstrualHistory: false, menstrual_history_irregular: [
                { text: 'Scanty', checked: false },
                { text: 'Moderate', checked: false },
                { text: 'Severe', checked: false },
                { text: 'Painless', checked: false },      
        ...
        onInvalidSubmit={this.handleInvalidSubmit}>
                    ...
                    <div className="col-md-3">
                      ...
                      <AvGroup>            
                        ...
                        <AvInput name='bsa' id='bsa' value={this.state.bsavalue} required value={this.state.bsavalue} onChange={(e) => this.setState({ bsavalue: e.target.value})}  onBlur={this.calculateBSA} />                        
                      </AvGroup>
                      </div>
                      ...
                      {showHRTuse && (
                        <div className="col-md-3">
                          <AvGroup>            
                            ...
                            <AvInput type='select' name='ifhrtuseyes' id='ifhrtuseyes' required value={this.state.reproductivew_history_hrt_use_if_yes} onChange={(e) => this.setState({ reproductivew_history_hrt_use_if_yes: e.target.value })} required>
                                <option value="" selected>Select</option>
